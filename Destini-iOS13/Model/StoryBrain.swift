...
struct StoryBrain {
    ...
    func getTitle() -> String {
       return stories[indexNumber].title
    }
    
    func firstChoice() -> String {
        return stories[indexNumber].choice1
    }
    
    func secondChoice() -> String {
        return stories[indexNumber].choice2
    }
    
    mutating func nextStory(_ userChoice: String){
        if userChoice == stories[indexNumber].choice1 {
            indexNumber = stories[indexNumber].choice1Destination
        } else if userChoice == stories[indexNumber].choice2 {
            indexNumber = stories[indexNumber].choice1Destination
        }
    }
}
